...
if __name__ == '__main__':
    ...
    dataset_model_lossfunc = 'Braindc_tdc_image_2c_l1x4'
    log_name = '../test_log'
    ...
    for i in range(start_epoch, end_epoch+1):
        checkpoint_path = '/home/data/ljh/Brain_MRI/Brain_MRI/checkpoints/Brain_TDC_image_2c_l1x4/epoch_{}.pth'.format(i)
