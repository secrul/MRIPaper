...
def test(model, test_dataloader, epochs,dataset_model_lossfunc):
    ...
    epoch_loss = 0
    step = 0
    # ansP = '/home/data/ljh/Brain_MRI/TestUnetx8'
    # ansP = '/home/data/ljh/Brain_MRI/ValUnetx4'
    for i,data in enumerate(test_dataloader): # 每个batch更新一次参数
        ...
        # print(file_name, type(slice_num))
        # ansF = os.path.join(ansP, file_name+str(slice_num)+'.npy')
        # np.save(ansF, (out * std).detach().cpu().numpy())
        # print(file_name)
        # print(ansF)
        # assert 1 > 7
...
if __name__ == '__main__':
    ...
    # test_root = '/home/data/ljh/Brain_MRI/Train'
    # test_root = '/home/data/ljh/Brain_MRI/Val'
    ...
    dataset_model_lossfunc = 'Braindc_unet_image_2c_l1x4'
    log_name = '../test_log'
    ...
    for i in range(start_epoch, end_epoch+1):
        checkpoint_path = '/home/data/ljh/Brain_MRI/Brain_MRI/checkpoints/Braindc_unet_image_2c_l1x4/epoch_{}.pth'.format(i)
