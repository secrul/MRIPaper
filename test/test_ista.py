...
if __name__ == '__main__':
    ...
    layer_num = 10
    dataset_model_lossfunc = 'Braindc_ista_image_2c_l1x8'
    log_name = '../test_log'
    ...
    for i in range(start_epoch, end_epoch+1):
        checkpoint_path = '/home/data/ljh/Brain_MRI/Brain_MRI/checkpoints/Brain_ISTA_image_2c_l1_x8/epoch_{}.pth'.format(i)
