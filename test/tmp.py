...
def test(model, test_dataloader, epochs):
    ...
    epoch_loss = 0
    step = 0
    ansP = '/home/data/ljh/Brain_MRI/TrainDcnnx4'
    # ansP = '/home/data/ljh/Brain_MRI/ValDcnnx4'
    # ansP = '/home/data/ljh/Brain_MRI/TestDcnnx4'
...
if __name__ == '__main__':
    ...
    dataset_model_lossfunc = 'Braindc_dcnn_image_2c_l1x4'
    log_name = '../test_log'
    ...
    for i in range(start_epoch, end_epoch+1):
        checkpoint_path = '/home/data/ljh/Brain_MRI/Brain_MRI/checkpoints/Braindc_DCNN_image_2c_l1X4/epoch_{}.pth'.format(i)
        state_dict = torch.load(checkpoint_path)
        model.load_state_dict(state_dict)
        model.eval()

        test(model, test_dataloader,i)
