...
class dataset_Brain(data.Dataset):
    ...
    """
    def __init__(self, root, acc=4, seed=None):
        self.seed = seed
        self.acc = acc
    ...
    def __getitem__(self, index: int):
        ...
        sample = kspace_data, mask_kspace, mask_image_2c, gt_img_2c, file_name, slice_num, mask, std
...
if __name__ == '__main__':
    path = '/home/data/ljh/Brain_MRI/Train'
    datas = dataset_Brain(path, acc=4)
